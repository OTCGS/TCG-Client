...
{
    /// <summary>
    /// NavigationManager bietet Unterstützung bei der Navigation zwischen Seiten.  Es werden Befehle zum 
    /// rückwärts und vorwärts navigieren sowie Register für Standardmaus und -tastatur 
    /// Verknüpfungen, um zum vorherigen oder zum nächsten Schritt zu wechseln.  Darüber hinaus wird SuspensionManger integriert
    /// zum Behandeln der Verwaltung der Prozesslebensdauer und der Zustandsverwaltung beim Navigieren zwischen
    /// kann.
    /// </summary>
    /// <example>
    /// Zur Verwendung von NavigationManager diesen Schritten folgen, oder
    ...
    /// </code>
    /// 
    /// 2) Die Seite für den Aufruf an NavigationManager registrieren, wenn die Seite 
