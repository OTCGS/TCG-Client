...
namespace Client.Pages
{
    ...
    /// </summary>
    public sealed partial class ServerOverview : Page
    {
        ...
        /// </summary>
        private Viewmodel.ServerOverviewViewmodel DefaultViewModel
        {
            get { return this.DataContext as Viewmodel.ServerOverviewViewmodel; }
        }
        ...
        public ServerOverview()
        {
            ...
            this.navigationHelper.GoBackCommand = new Client.Common.RelayCommand(() => this.GoBack(), () => this.CanGoBack());
        ...
        /// </summary>
        /// <param name="sender">Die Quelle des Ereignisses, normalerweise <see cref="Common.NavigationHelper"/></param>
