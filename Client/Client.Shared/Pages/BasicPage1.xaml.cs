...
// Wird nicht mehr gebraucht
            //var servicePortClient = new CardServerService.ServicePortClient();
            //var erg = await servicePortClient.getHeadsAsync(new CardServerService.getHeadsRequest());
            //erg.getHeadsResponse1.First().transfers.First().
        }
